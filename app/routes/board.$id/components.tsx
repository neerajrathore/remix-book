...
>((props, ref) => {
  return (
    <button
      ...
      tabIndex={0}
      {...props}
      className="text-sm rounded-lg text-left p-2 font-medium hover:bg-slate-200 focus:bg-slate-200 bg-white text-black"
    />
  );
});
...
export function EditableText({
  ...
  // optimistic update
  // ask remix what's going over the network and use that value.
